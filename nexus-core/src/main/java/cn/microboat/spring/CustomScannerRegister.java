...
public class CustomScannerRegister implements ImportBeanDefinitionRegistrar, ResourceLoaderAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry registry) {
        ...
        log.info("Spring Bean Scanner 扫描的数量：[{}]", springBeanAmount);
        int customAmount = customScanner.scan(scanBasePackages);
        log.info("RPC Service Scanner 扫描的数量：[{}]", customAmount);
    }
}
